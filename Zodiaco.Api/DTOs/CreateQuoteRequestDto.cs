...
/// <summary>
/// Request body for creating a public quote request.
/// </summary>
public sealed class CreateQuoteRequestDto : IValidatableObject
{
    /// <summary>
    /// Public truck identifier to quote.
    /// </summary>
    [Required]
    ...
    /// <summary>
    /// Optional quote request message.
    /// </summary>
    [StringLength(2000)]
    ...
    public IEnumerable<ValidationResult> Validate(ValidationContext validationContext)
    {
        ...
        {
            yield return new ValidationResult("The TruckId field is required.", [nameof(TruckId)]);
        }
